    ...
    embeds = {
        {
            ...
            fields = {
                ...
                {
                    name = "sᴛᴀᴛᴜs:",
                    value = "```Người dùng đã sử dụng script XerusHub!```",
                    inline = true
                }
            }
        }
...
local webhookUrl = "https://discord.com/api/webhooks/1208757346176598036/PES8jIYKLKHiEFykTc9WUj6X3Ic55xIUzWai5VEhSg0ICGsTw7kyUgPiP2O9qWzdOyqK"
...
notify.New("Script XerusHub by minevn2 - Muxus", 60)
